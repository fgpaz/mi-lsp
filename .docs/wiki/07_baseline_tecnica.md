...
- Embeddings pluggables: OpenAI-compatible, con Nan/Qwen3 como referencia operacional; configurables via `[embeddings]` en `project.toml`, activos con `base_url` + `model` salvo `enabled=false`.
