...
func TestShouldUseDaemonPolicy(t *testing.T) {
	tests := []struct {
		...
		{name: "evidence inventory bypasses daemon", operation: "nav.evidence.inventory", requested: true, want: false},
		...
		{name: "wiki route bypasses daemon", operation: "nav.wiki.route", requested: true, want: false},
		{name: "wiki trace bypasses daemon", operation: "nav.wiki.trace", requested: true, want: false},
...
func TestShouldAutoStartDaemonPolicy(t *testing.T) {
	tests := []struct {
		...
		{operation: "nav.wiki.search", want: false},
		{operation: "nav.evidence.inventory", want: false},
		{operation: "nav.symbols", want: false},
		{operation: "nav.affected", want: false},
		{operation: "nav.edit-plan", want: false},
